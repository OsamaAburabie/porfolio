    ...
    <>
      ...
      <div className="explorer">
        ...
        <div className={`explorer__files ${isOpen ? "" : "hide-files"}`}>
          <NavLink to="/" className="file" activeClassName="active-file" exact>
            <img src={ReactLogo} alt="ReactLogo" />
            <p>Home.jsx</p>
          </NavLink>
          <NavLink to="/about" className="file" activeClassName="active-file">
            <img src={JsLogo} alt="ReactLogo" />
            <p>About.js</p>
          </NavLink>
          <NavLink to="/contact" className="file" activeClassName="active-file">
          ...
          <NavLink to="/github" className="file" activeClassName="active-file">
